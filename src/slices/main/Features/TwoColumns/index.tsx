...
export type FeaturesTwoColumnsProps = {
  slice: Content.MainFeaturesSliceTwoColumns;
  theme: SliceZoneContext["theme"];
};

const FeaturesTwoColumns = ({ slice, theme }: FeaturesTwoColumnsProps) => {
              ...
              <li key={index} className="w-full px-2 2xl:px-3 md:w-1/2 grow">
                ...
                >
                  ...
                  <CallToActions
                    ...
                    theme={theme}
                    clickPosition="features_TwoColumns"
...
export default FeaturesTwoColumns;
