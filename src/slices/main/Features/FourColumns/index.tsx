...
export type FeaturesFourColumnsProps = {
  slice: Content.MainFeaturesSliceFourColumns;
  theme: SliceZoneContext["theme"];
};

const FeaturesFourColumns = ({ slice, theme }: FeaturesFourColumnsProps) => {
        ...
        <div className="mt-8 2xl:mt-14 first:mt-0">
          <ul className="flex flex-wrap gap-y-4 2xl:gap-y-6 -mx-2 2xl:-mx-3">
            {slice.items.map((item, index) => (
              <li
                key={index}
                className="w-full px-2 2xl:px-3 md:w-1/2 lg:w-1/4 grow"
              >
                <div
                  className={clsx(
                ...
                >
                  ...
                  <CallToActions
                    ...
                    theme={theme}
                    clickPosition="features_FourColumns"
