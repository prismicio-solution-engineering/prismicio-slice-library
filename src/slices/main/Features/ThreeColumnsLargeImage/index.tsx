...
export type FeaturesThreeColumnsLargeImageProps = {
  slice: Content.MainFeaturesSliceThreeColumnsLargeImage;
  theme: SliceZoneContext["theme"];
};

const FeaturesThreeColumnsLargeImage = ({
  slice,
  theme
}: FeaturesThreeColumnsLargeImageProps) => {
...
export default FeaturesThreeColumnsLargeImage;
