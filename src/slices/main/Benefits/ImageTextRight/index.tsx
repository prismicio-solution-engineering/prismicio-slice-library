...
export type BenefitsImageTextRightProps = {
  slice: Content.MainBenefitsSliceImageTextRight;
  theme: SliceZoneContext["theme"];
};

const BenefitsImageTextRight = ({
  slice,
  theme
      ...
      <div className="container flex flex-col md:flex-row gap-6 md:items-center">
        <div className="md:w-1/2 order-2 md:order-first md:pr-14">
          ...
          <CallToActions
            className="mt-8"
            items={slice.items}
            clickPosition="benefits_imageTextRight"
          />
        </div>
...
export default BenefitsImageTextRight;
