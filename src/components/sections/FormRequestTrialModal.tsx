...
const FormRequestTrial = ({ isOpen, onClose }: FormRequestTrialProps) => {
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [email, agency, companySize, domain, mobile]);
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose}>
      ...
      <Copy className="mt-6" muted theme="light">
        Please leave your contact information and we will get back to you on the
        next business day.
      </Copy>
      <form
        onSubmit={(e) => {
...
export default FormRequestTrial;
